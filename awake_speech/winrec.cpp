...
/* signaled: the message queque has been created in the thread */
static HANDLE msgqueue_ready_evt = NULL;
//打印波形头
...
int create_recorder(struct recorder** out_rec, void (*on_data_ind)(char* data, unsigned long len, void* user_cb_para), void* user_cb_para)
{
